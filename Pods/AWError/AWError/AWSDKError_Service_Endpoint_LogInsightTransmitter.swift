//
//  AWSDKError_Service_Endpoint_LogInsightTransmitter.swift
//  AWError
//
...
public extension AWError.SDK.Service.Endpoint {
    enum LogInsightTransmitter: AWSDKErrorType {
...
public extension AWError.SDK.Service.Endpoint.LogInsightTransmitter {
