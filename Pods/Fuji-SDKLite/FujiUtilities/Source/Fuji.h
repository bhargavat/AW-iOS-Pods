...
#define LOG_ERROR(...)             //NSLog(FUJI_LOG_ERROR, ##__VA_ARGS__)
#define LOG_WARNING(...)           //NSLog(FUJI_LOG_WARN, ##__VA_ARGS__)
#define LOG_INFO(...)             // NSLog(FUJI_LOG_INFO, ##__VA_ARGS__)
#define LOG_VERBOSE_NOFLUSH(...)   //NSLog(FUJI_LOG_VERBOSE, ##__VA_ARGS__)
#ifdef DEBUG
#define LOG_DEBUG(...)             //NSLog(FUJI_LOG_DEBUG, ##__VA_ARGS__)
#else
