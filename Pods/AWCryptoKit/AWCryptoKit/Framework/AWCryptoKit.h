...
//! Project version number for AWCryptoKit.
FOUNDATION_EXPORT double AWCryptoKitVersionNumber;

//! Project version string for AWCryptoKit.
FOUNDATION_EXPORT const unsigned char AWCryptoKitVersionString[];


/******************************************************************************
 * Using Common Crypto in Swift Frameworks is not straight forward as there is
 * no special module available. Things get even more complicated when we need to
 * provide Swift Source that was installed through cocoapods. Swift code will
 * not find Common Crypto headers to compile even though Common Crypto is
 * inherently linked to the application.
 * This seemed to be simple and most reliable way to fix this problem.
